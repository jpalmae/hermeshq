    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Hermes Agent Versions ahora funciona como catálogo persistente. Desde Settings puedes registrar versiones nuevas con `version`, `release tag` y descripción sin modificar el backend.",
          ...
          "Una vez instalada, puedes dejarla como default global o fijarla por agente desde Agent Detail. Eso permite rollout controlado, por ejemplo mantener `0.8.0` estable y probar `0.9.0` solo en agentes canary.",
      ...
      },
      {
        ...
        bullets: [
          "El flujo correcto es `Add to catalog -> Install -> Set as default` o `pin por agente`. `Add to catalog` solo crea la entrada administrativa; no descarga ni instala nada todavía.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Settings is now organized into internal tabs: `General`, `Runtime`, `Providers`, `Integrations`, `Hermes Versions`, `Secrets`, and `Templates`. This keeps the page usable while those domains still live under one admin surface.",
          ...
          "Hermes Agent Versions now works as a persistent catalog. From Settings you can register new versions with `version`, `release tag`, and description without modifying backend code.",
          ...
          "Once installed, you can keep it as the global default or pin it per agent from Agent Detail. That enables controlled rollout, such as keeping `0.8.0` stable while testing `0.9.0` only on canary agents.",
      ...
      },
      {
        ...
        bullets: [
          "The correct flow is `Add to catalog -> Install -> Set as default` or `pin per agent`. `Add to catalog` only creates the administrative entry; it does not download or install anything yet.",
